...
def get_ip_data():
    ...
    input_switchtype = input("\nWhat is the switch type (IP or FC)? ")
    input_location = input("What is the location? ")
    d = {"IP": input_ip, "driver": input_driver, "SwitchType": input_switchtype, "Location": input_location}
    return d
